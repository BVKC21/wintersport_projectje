...
stad = px.histogram(waarden[waarden.stad !='Volgens mij mag je nu wel een feest organiseren zolang er maar niemand komt '].dropna(), 
x="stad").update_xaxes(categoryorder='total descending')
stad.update_layout(
    title={
        'text': "Waar vier je nou een Preski feestje?",
        'y':0.9,
        'x':0.5,
        'xanchor': 'center',
        'yanchor': 'top'},
